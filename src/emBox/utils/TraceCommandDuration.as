  ...
  import emBox.commands.CEvent;
	...
	public class TraceCommandDuration{
		...
		public function TraceCommandDuration( aCmnd:ACommand){
			this.aCmnd = aCmnd;
			aCmnd.addEventListener( CEvent.EXECUTING_IN, onIn);
			aCmnd.addEventListener( CEvent.EXECUTE_IN_COMPLETE, onInComplete);
			aCmnd.addEventListener( CEvent.EXECUTING_OUT, onOut);
			aCmnd.addEventListener( CEvent.EXECUTE_OUT_COMPLETE, onOutComplete);
		}
