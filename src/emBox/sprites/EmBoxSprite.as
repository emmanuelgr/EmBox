...
import emBox.interfaces.IEmBoxSprite;
import emBox.interfaces.IUpdate;
...
public class EmBoxSprite extends DebugSprite implements IEmBoxSprite{
  ...
  override public function debug(value:Boolean = true):void {
    debug_Icon = new Cross(10,1,0xffffff,1, NineGrid.MiddleMiddle);
    super.debug(value);
  }
