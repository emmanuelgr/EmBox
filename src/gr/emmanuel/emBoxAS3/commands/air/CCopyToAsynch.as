package gr.emmanuel.emBoxAS3.commands.air {
 ...
 * @author Emmanuel
 */
public class CCopyToAsynch extends ACommand {
	private var file:File;
	private var destination:File;
	private var overwrite:Boolean;
	
	public function CCopyToAsynch(file:File,destination:File, overwrite:Boolean=false) {
		super();
	...
	override protected function doIn():void {
		...
		file.copyToAsync(destination, overwrite);
	}
