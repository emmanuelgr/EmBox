...
import gr.emmanuel.emBoxAS3.dataObjects.VectorIterartor;
...
public class COverlap extends ACommand {
	private var cmnds:VectorIterartor;
	...
	override protected function doIn():void {
		...
		if(aCmnd) {
			...
			for(var i:int = 0; i < cmnds.list.length; i++) {
				...
				//remListFromCmnd.removeEventListener(CommandEvent.EXECUTE_IN_COMPLETE, onSubcommandCompleteIn);
				remListFromCmnd.removeEventListener(CommandEvent.EXECUTE_OUT_COMPLETE, onSubcommandCompleteOut);
			}
	...
	private function onSubcommandCompleteIn(e:Event = null):void {
		e.target.removeEventListener(CommandEvent.EXECUTE_IN_COMPLETE, onSubcommandCompleteOut);
	...
	private function onSubcommandCompleteOut(e:Event = null):void {
		e.target.removeEventListener(CommandEvent.EXECUTE_OUT_COMPLETE, onSubcommandCompleteOut);
