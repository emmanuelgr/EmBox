...
public class CDelay extends ACommand {
  ...
  private function onTimerCompleteIn(e:TimerEvent):void {
    ...
    cmnd.addEventListener(CommandEvent.EXECUTE_IN_COMPLETE, executeInComplete);
    cmnd.executeIn();
  }
  override protected function postExecuteIn():void {
    cmnd.removeEventListener(CommandEvent.EXECUTE_IN_COMPLETE, executeInComplete);
    timerIn.reset();
  }
  ...
  private function onTimerCompleteOut(e:TimerEvent):void {
    timerOut.removeEventListener(TimerEvent.TIMER_COMPLETE, onTimerCompleteOut);
    cmnd.addEventListener(CommandEvent.EXECUTE_OUT_COMPLETE, executeOutComplete);
    cmnd.executeOut();
  }
  override protected function postExecuteOut():void {
    cmnd.removeEventListener(CommandEvent.EXECUTE_OUT_COMPLETE, executeOutComplete);
    timerOut.reset();
  }
