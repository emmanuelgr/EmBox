...
public class CMenuThumbsManager extends CThumbsManager{
  ...
  override protected function onClick(e:MouseEvent):void {
    ...
    var aVO:VO = voList.objectByPropertyWithValue("href", aVOMenu.href) as VO;
    if (aVO) {
      /// update global list
  ...
  protected function onGlobalModelPointer(e:Event):void {
    ...
    var href:String = voList.pointedObj["href"];
    /// Get the VOMenu from the local
    aVOMenu = menuList.objectByPropertyWithValue("href", href) as VOMenu;
    if (aVOMenu) {
