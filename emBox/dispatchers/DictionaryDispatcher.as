...
import emBox.events.DictionaryEvent;
...
public class DictionaryDispatcher extends EventDispatcher {
	...
	public function addValue(key:String, value:*):void {
		...
		if (oldValue != value) {
			if (oldValue === undefined) {
				dispatchEvent(new DictionaryEvent(DictionaryEvent.VALUE_ADD, false, false, key, value));
			} else {
				dispatchEvent(new DictionaryEvent(DictionaryEvent.VALUE_CHANGE, false, false, key, value, oldValue));
			}
		}
	}
	...
	public function removeValue(key:String):void {
		...
		if (value !== undefined) {
			...
			dispatchEvent(new DictionaryEvent(DictionaryEvent.VALUE_REMOVE, false, false, key, value));
		}
	}
